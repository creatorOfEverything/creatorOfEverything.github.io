...
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    ...
    scrolled > 50 ? $('.navigation').addClass('navigation_scrolled') : $('.navigation').removeClass('navigation_scrolled');
    scrolled > 50 ? $('.l-slide-out-menu-header').addClass('l-slide-out-menu-header_scrolled') : $('.l-slide-out-menu-header').removeClass('l-slide-out-menu-header_scrolled');
  });
  $('.carousel').carousel({
    interval: 20000
  });
  $('.tabs-toggler__tab').click(function () {
    ...
    var plan = $(this).data('plan'); // С учетом отступов

    $('.tabs-toggler__switcher').css('left', "".concat(moveTo - 4, "px"));
    ...
    $(".cards#".concat(plan)).addClass('cards_active');
    $(".cards#".concat(plan)).find('.cards__card-container').addClass('cards__card-container_active');
  });
});